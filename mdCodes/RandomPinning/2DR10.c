...
/*----------------------------------------------Force calculation for 2d system-----------------------------------------------*/
/*-------------------------------------------------------------------------------------------------------------------------*/
void calculateForces(){
	int i,j,m,k,typeI;
	double g,dx,dy,rxi,ryi,r2OverSigma2,invSigmaSqrd;
...
void equilibratePinned(double duration){
	...
	sprintf(restartFileName,"/restartPostEq_%d_%.3f.dat",N,T);
